...
const popupBuy = document.querySelector(".popup-shop");
const btnBuyAccept = document.querySelector(".popup-box .button-accept");
const btnBuyDecline = document.querySelector(".popup-box .button-decline");
